import { Modal, ScrollView, StyleSheet, TouchableOpacity, View, StatusBar, RefreshControl } from 'react-native';
...
const BuyerDashboardScreen = () => {
    ...
    const { data: dashboardContent, isPending: loading, refetch, isError: dashboardError } = useBuyerDashboard();
    const { data: logs, isPending: loadingLogs, refetch: refetchLogs, isError: logsError } = useBuyerActivityLogs();
