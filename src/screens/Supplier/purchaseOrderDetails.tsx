...
const SupplierPurchaseorderDetailsScreen = () => {
    ...
    // Status can be 0 (none), 1 (loading approve), 2 (loading reject)
...
const styles = StyleSheet.create({
    ...
    approveButton: {
        flex: 1,
        backgroundColor: colors.semantic.success.default, // Fixed
        borderRadius: borderRadius.base,
    },
    rejectButton: {
        flex: 1,
        borderColor: colors.semantic.error.default, // Fixed
        borderRadius: borderRadius.base,
    },
    buttonLabel: {
