...
const SupplierClientsScreen = () => {
    ...
    const renderClient = ({ item }: { item: Client }) => (
        <TouchableOpacity
            ...
            onPress={() => navigation.navigate('SupplierClientDetails', { clientId: item.id })}
            activeOpacity={0.7}
        >
    ...
    const EmptyState = () => (
        <View style={styles.emptyState}>
            <Icon source="domain" size={64} color={colors.neutral.text.tertiary} />
    ...
    const displayClients = error ? [] : filteredClients;
